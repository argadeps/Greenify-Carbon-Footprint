...
const CarbonForm = () => {
    ...
    return (<div>
      {/* Log Entry Button */}
      {!showForm && (<button onClick={handleButtonClick} id="log-entry" className="btn btn-success w-100">
          Log Entry
        </button>)}

      {/* Form that pops up when the button is clicked */}
      {showForm && (<form onSubmit={handleSubmit} id="carbon-form" className="p-4 bg-light rounded shadow-sm max-w-md mx-auto">
          {/* Location */}
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <input type="number" name="electricity" value={formData.electricity} onChange={handleChange} required className="form-control"/>
          </div>

          {/* Transportation */}
          <div className="mb-3">
            <label className="form-label">Transportation Type:</label>
            <select name="transportation" value={formData.transportation} onChange={handleChange} required className="form-select">
          ...
          {formData.transportation === 'car' && (<div className="mb-3">
              <label className="form-label">Car Fuel Type:</label>
              <select name="carType" value={formData.carType} onChange={handleChange} className="form-select">
          ...
          <div className="mb-3">
            ...
            <select name="diet" value={formData.diet} onChange={handleChange} required className="form-select">
          ...
          <div className="mb-3">
            ...
            <input type="range" name="waterUsage" min="0" max="100" value={formData.waterUsage} onChange={handleChange} className="form-range"/>
